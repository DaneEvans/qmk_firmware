...
#define override_value(h, s, v, Override) h, s , Override   // not the right numkber of elements (get 2, want 4 ) 

#define override_value_single(hsv, Override) override_value(hsv,Override)

//#define unwrap(...) {__VA_ARGS__[0] , __VA_ARGS__[1], __VA_ARGS__[2]}
*/

#define override_value_separate(h, s, v, Override) h, s , Override   // not the right numkber of elements (get 2, want 4 ) 

#define override_value_single_hsv(hsv, Override) override_value_separate(hsv,Override)
...
const rgblight_segment_t PROGMEM layer_qwerty_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_RED, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_RED},
    {7, 4, HSV_RED},
    {25, 2, HSV_RED},
	{35+0, 1, TO_HSV(override_value_single_hsv(HSV_RED, INDICATOR_BRIGHTNESS))},
    {35+1, 5, HSV_RED},
    {35+7, 4, HSV_RED},
    {35+25, 2, HSV_RED}    
);
const rgblight_segment_t PROGMEM layer_colemakdh_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_PINK, INDICATOR_BRIGHTNESS))},
    {1, 19, HSV_PINK}
);
...
const rgblight_segment_t PROGMEM layer_num_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_TEAL, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_TEAL},
    {7, 4, HSV_TEAL},
    {25, 2, HSV_TEAL},
	{35+0, 1, TO_HSV(override_value_single_hsv(HSV_TEAL, INDICATOR_BRIGHTNESS))},
    {35+1, 5, HSV_TEAL},
    {35+7, 4, HSV_TEAL},
    {35+25, 2, HSV_TEAL}  
);
...
const rgblight_segment_t PROGMEM layer_symbol_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_BLUE, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_BLUE},
    {7, 4, HSV_BLUE},
    {25, 2, HSV_BLUE},
	{35+0, 1, TO_HSV(override_value_single_hsv(HSV_BLUE, INDICATOR_BRIGHTNESS))},
    {35+1, 5, HSV_BLUE},
    {35+7, 4, HSV_BLUE},
    {35+25, 2, HSV_BLUE}  
    );
...
const rgblight_segment_t PROGMEM layer_command_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_PURPLE, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_PURPLE},
    {7, 4, HSV_PURPLE},
    {25, 2, HSV_PURPLE},
	{35+0, 1, TO_HSV(override_value_single_hsv(HSV_PURPLE, INDICATOR_BRIGHTNESS))},
    {35+1, 5, HSV_PURPLE},
    {35+7, 4, HSV_PURPLE},
    {35+25, 2, HSV_PURPLE}  
);
...
const rgblight_segment_t PROGMEM layer_numpad_lights[] = RGBLIGHT_LAYER_SEGMENTS(
	{0, 1, TO_HSV(override_value_single_hsv(HSV_ORANGE, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_ORANGE},
    {7, 4, HSV_ORANGE},
    {25, 2, HSV_ORANGE},
	{0, 1, TO_HSV(override_value_single_hsv(HSV_ORANGE, INDICATOR_BRIGHTNESS))},
...
const rgblight_segment_t PROGMEM layer_switcher_lights[] = RGBLIGHT_LAYER_SEGMENTS( 
	{0, 1, TO_HSV(override_value_single_hsv(HSV_GREEN, INDICATOR_BRIGHTNESS))},
    {1, 5, HSV_GREEN},
    {7, 4, HSV_GREEN},
    {25, 2, HSV_GREEN},
	{35+0, 1, TO_HSV(override_value_single_hsv(HSV_GREEN, INDICATOR_BRIGHTNESS))},
    {35+1, 5, HSV_GREEN},
    {35+7, 4, HSV_GREEN},
    {35+25, 2, HSV_GREEN}  
);
